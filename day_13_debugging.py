...
for number in range(1, 101):
  if number % 3 == 0 and number % 5 == 0: #changed or to and operator
    print("FizzBuzz")
  elif number % 3 == 0: # changed if statements to elif
    print("Fizz")
  elif number % 5 == 0:
    print("Buzz")
  else:
    print(number) # changed to just print number, not array number